<template>
      <div className="relative flex items-center" v-click-away="onClickAway">
        ...
        <div v-if="isSearching" class="absolute bg-gray-50 border-b border-r border-l py-3 w-full mt-28 rounded-b-xl">
          <div v-show="data.length > 0" class="flex flex-col py-4">
            ...
            >
              <div class="flex hover:bg-gray-100 py-2 px-1.5 items-center justify-between">
